/* http://tinyurl.com/PasswordUtil-class-php is pretty neat.
 *
...
#if FMT_EXTERNS_H
extern struct fmt_main fmt_wbb4;
#elif FMT_REGISTERS_H
john_register_one(&fmt_wbb4);
#else
...
#define FORMAT_LABEL			"wbb4"
#define FORMAT_NAME			"wbb4"
